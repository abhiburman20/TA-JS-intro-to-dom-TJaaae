// BODY - Reset
document.body.style = "margin: 0; background-color: #8ea6a9";
// Header
document.querySelector("header").style = "background-color: #377e80; padding: 5px; text-align: center;";
document.querySelector("h1").style = "color: #eff45f";
// Book-shelf
...
allbooks.books.forEach((bookdetail) => {
    let li = document.createElement("li");
    let img = document.createElement("img");
    img.src = bookdetail.image;
    let h2 = document.createElement("h2");
    h2.innerText = bookdetail.title;
    let h3 = document.createElement("h3");
    h3.innerText = bookdetail.author;
    let a = document.createElement("a");
    a.innerText = "BUY";
    a.classList.add("buy-btn");

    a.href = bookdetail.website;

    li.append(img,h2,h3,a);
    ul.append(li);
});
document.querySelector(".book-shelf").append(ul);